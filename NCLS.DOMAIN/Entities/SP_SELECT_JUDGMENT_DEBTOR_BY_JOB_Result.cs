...
namespace NCLS.DOMAIN.Entities
{
    ...
    public partial class SP_SELECT_JUDGMENT_DEBTOR_BY_JOB_Result
    {
        ...
        public string JD_DEBTOR_STATUS_NAME_TH { get; set; }
        public string JD_ID1 { get; set; }
        public string JD_TYPE { get; set; }
        public string JD_JOB_ID1 { get; set; }
